...
Every Ritual command, grouped by what it works on. Each page opens with usage and options, then covers behavior, examples, and exit codes. Global options, scripting output, and exit codes shared by all commands are on [CLI Conventions](/cli-conventions/).
