...
| `import_deck`           | Import a deck from a URL or pasted decklist text. Text lines the parser cannot read are skipped and reported in the result's `warnings` array (empty for URL imports) — a non-empty array means part of the pasted text was not imported.                                                                                                                                                                                                   |
