---
title: 'Find in Lists'
description: See every other copy of one card across all your lists, straight from the card you are looking at.
---

**Find in Lists** answers "where else do I have a version of this card?" for any single card, right from the card you're looking at. It searches every deck, collection, and wanted list on the site and shows each physical copy, grouped by the list it lives in. It is built for visually upgrading a deck (compare the printing you're running against the copies sitting in your binders), but works just as well for spotting that a collection card is already being played in a deck, or hiding in a trade binder.
