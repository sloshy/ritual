...
/**
 * Autocomplete card names for a partial query. Scryfall ranks its suggestions by
 * popularity, so a name the query already spells out in full is floated to the
 * top (see {@link promoteFullNameMatches}).
 */
