...
export const cliCardsMessages = {
  ...
  'cli.move.menuBatch': '🧺 Batch Mode — select many cards at once',
  ...
  'cli.move.sectionPrompt': 'Section in {list}:',
  'cli.move.sectionNew': '➕ New section…',
  'cli.move.sectionNewPrompt': 'New section name:',
  'cli.move.sectionNameInvalid':
    "'{name}' is not a usable section name — drop the leading '#' and any line breaks.",
  'cli.move.batchNoSources': 'No lists selected to view. Leaving batch mode.',
  'cli.move.batchNoCards': 'No cards left to move in the selected lists. Leaving batch mode.',
  'cli.move.batchPrompt': 'Select cards to move ({count} selected), or choose an option:',
  'cli.move.batchDone': {
    $plural: 'count',
    one: '✅ Done selecting ({count} card)',
    other: '✅ Done selecting ({count} cards)',
  },
  'cli.move.batchSelectAll': '☐ Select all',
  'cli.move.batchDeselectAll': '☑ Deselect all',
  'cli.move.batchSelectAllFrom': '☑ Select all from…',
  'cli.move.batchExit': '⬅ Exit batch mode',
  'cli.move.batchNoneSelected': 'No cards selected yet. Pick at least one card to move.',
  'cli.move.batchSelectFromPrompt': 'Select every card from which lists?',
  'cli.move.batchAllSelectedLists': '★ All selected lists',
  'cli.move.batchContinue': '→ Continue',
  'cli.move.batchNoListsPicked': 'No lists picked. Choose a list, or “All selected lists”.',
  'cli.move.batchDestination': {
    $plural: 'count',
    one: 'Move {count} selected card to:',
    other: 'Move {count} selected cards to:',
  },
  'cli.move.batchQueued': {
    $plural: 'count',
    one: '  ✓ Queued {count} card → {list}',
    other: '  ✓ Queued {count} cards → {list}',
  },
  'cli.move.batchSkippedSameList': {
    $plural: 'count',
    one: '  ⚠ Skipped {count} card already in that list.',
    other: '  ⚠ Skipped {count} cards already in that list.',
  },
  'cli.move.batchSkippedPrinting': {
    $plural: 'count',
    one: '  ⚠ Skipped {count} card with no resolved printing.',
    other: '  ⚠ Skipped {count} cards with no resolved printing.',
  },
  'cli.move.batchAbandoned': {
    $plural: 'count',
    one: '  ⚠ Cancelled — {count} card was left unqueued.',
    other: '  ⚠ Cancelled — {count} cards were left unqueued.',
  },
  ...
  'cli.move.toggleListsPrompt': {
    ...
    batch: 'Batch Mode — Toggle Lists to View:',
  },
  ...
  'cli.metadata.unknownField': {
    ...
    wanted: "Unknown metadata field '{property}'. Accepted fields for a wanted list: {keys}.",
  },
  ...
  'cli.metadata.storedDescriptionInvalid': "The stored 'description' value is invalid: {reason}",
  'cli.metadata.arrayOnly': {
    $select: 'type',
    deck: "--add/--remove apply to array properties (a deck's: tags).",
    collection: "--add/--remove apply to array properties (a collection's: labels).",
    wanted: '--add/--remove apply to array properties; a wanted list has none.',
  },
