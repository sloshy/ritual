...
export const cliSyncMessages = {
  ...
  'cli.import.invalidDeckFileName': "Name '{name}' is not a valid deck file name",
  'cli.import.renameTargetExists': "File '{file}' also exists. Aborting.",
  'cli.import.fileExists': 'File exists',
