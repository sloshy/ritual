...
export const siteChromeMessages = {
  ...
  'site.filter.sharedWith': 'Shares Cards With',
  'site.filter.sharedWithMode': 'Shared list combination',
  'site.filter.sharedWithMatch': 'Shared card identity',
  'site.filter.notSharedWith': "Doesn't Share Cards With",
  'site.filter.notSharedWithMatch': 'Excluded card identity',
  'site.filter.shareListsPlaceholder': 'Lists…',
  'site.filter.sharedWithSuggestions': 'Shared list suggestions',
  'site.filter.notSharedWithSuggestions': 'Excluded list suggestions',
  'site.filter.shareListWithType': '{name} ({type})',
  ...
  'site.filter.tags': 'Tags',
  'site.filter.tagMode': 'Tags match mode',
  'site.filter.tagsPlaceholder': 'Signed, Trade Binder',
  'site.filter.tagsSuggestions': 'Tag suggestions',
  ...
  'site.filterMode.any': 'Any',
  'site.filterMode.all': 'All',
  'site.filterMode.printing': 'Printing',
  ...
  'site.filterMode.tagInclude': 'Keep cards carrying any of the selected tags',
  'site.filterMode.tagExclude': 'Hide cards carrying any of the selected tags',
  'site.filterMode.tagExact': 'Keep cards carrying every selected tag',
  ...
  'site.filterMode.sharedAny': 'Keep cards also in at least one selected list',
  'site.filterMode.sharedAll': 'Keep cards also in every selected list',
  'site.filterMode.sharedByName': 'Match shared cards by card name',
  'site.filterMode.sharedByPrinting':
    'Match shared cards by exact printing (set and collector number)',
  'site.filterMode.notSharedByName': 'Match excluded cards by card name',
  'site.filterMode.notSharedByPrinting':
    'Match excluded cards by exact printing (set and collector number)',
  ...
  'site.themeVar.labelAnyPrinting.description':
    'Tone of the ANY tag on deck and wanted cards that pin no printing and show a representative one.',
