...
export const siteCardsMessages = {
  ...
  'site.selection.view': 'View selected cards…',
  ...
  'site.selection.scope': 'Show:',
  'site.selection.scopeCurrent': 'This page ({count})',
  'site.selection.scopeAll': 'All lists ({count})',
  'site.selection.emptyCurrent': 'No cards are selected on this page.',
  'site.selection.actionsCopy': 'Copy',
  'site.selection.actionsEdit': 'Edit',
  'site.selection.actionsSelection': 'Selection',
