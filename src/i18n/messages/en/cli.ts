...
export const cliMessages = {
  ...
  'cli.prompt.subject.sectionName': 'a name for the new deck section',
  'cli.prompt.subject.addSection': 'the deck section to add the card to',
  'cli.prompt.subject.targetSection': 'the section new cards should go to',
  'cli.prompt.subject.moveSection': 'the deck section to move the line into',
  'cli.prompt.subject.setFilter': 'the session set filter',
  'cli.prompt.subject.editAction': 'what to change on the card',
  'cli.prompt.subject.noteText': 'the note text',
  'cli.prompt.subject.tagsText': 'the tags',
  'cli.prompt.subject.categoriesText': 'the categories',
  'cli.prompt.subject.categoryChoice': 'a category',
  'cli.prompt.subject.categoryName': 'the new category name',
  'cli.prompt.subject.categoryOrderText': 'the category order',
  'cli.prompt.subject.sessionChange': 'a pending change to act on',
  'cli.prompt.subject.changeAction': 'what to do with the pending change',
  'cli.prompt.subject.sessionCard': 'a card to add, or a menu option',
  'cli.prompt.subject.listToEdit': 'a list to edit',
  'cli.prompt.subject.newListName': 'a name for the new list',
  'cli.prompt.subject.addTarget': 'a list to add the card to',
  'cli.prompt.subject.printing': 'a printing of the card',
  'cli.prompt.subject.languageFallback': 'whether to add the card in another language',
  'cli.prompt.subject.finish': 'a finish',
  'cli.prompt.subject.condition': 'a condition',
  'cli.prompt.subject.language': 'a card language',
  'cli.prompt.subject.cardLabel': 'a label for the card',
  'cli.prompt.subject.defaultLabels': 'the default labels for cards added to the list',
  'cli.prompt.subject.wantedFinish': 'a preferred finish, or no preference',
  'cli.prompt.subject.specificity': 'whether to want a specific printing or any printing',
  'cli.prompt.subject.deckTags': 'the deck tags',
  'cli.prompt.subject.removeConfirm': 'confirmation to remove the card',
  ...
  'cli.menu.changeLastLanguage': 'Change Language ({name})',
  'cli.menu.cardLanguage': 'Card Language ({language})',
  ...
  'cli.session.loadedPrintings': 'Loaded {count} printings.',
  ...
  'cli.session.switchedToCollector':
    'Switched to collector number mode. Search by set code and/or collector number.',
  ...
  'cli.session.collectorChoice': '{printing} — {name}',
  ...
  'cli.session.promptTagsEdit': 'Tags (separated by spaces or commas; empty clears them):',
  'cli.session.promptCategoriesEdit':
    'Categories (comma-separated, first is primary; empty clears them):',
  'cli.session.promptCategoryRenameFrom': 'Which category should be renamed?',
  'cli.session.promptCategoryRenameTo': 'New name for "{category}":',
  'cli.session.promptCategoryOrder': 'Category order (comma-separated, first is shown first):',
  'cli.session.categoriesSidecarUnreadable':
    "The list's categories sidecar could not be read, so its categories were left unchanged: {reason}",
  'cli.session.categoriesPruned': 'Dropped categories for cards no longer in this list: {names}',
  ...
  'cli.session.promptPickChange': {
    $plural: 'count',
    one: '{count} change this session — select one:',
    other: '{count} changes this session — select one:',
  },
  'cli.session.promptChangeAction': '{label}:',
  'cli.session.changeActionDetails': 'Edit This Card',
  'cli.session.changeActionLanguage': 'Change This Card’s Language',
  'cli.session.changeActionDiscard': 'Discard This Change',
  'cli.session.cardLanguageSet': 'Cards added from here on are {language} ({code}).',
