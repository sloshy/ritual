...
export const cliEditMessages = {
  ...
  'cli.editLabel.tags': 'tags on {name}',
  'cli.editLabel.categories': 'categories on {name}',
  ...
  'cli.editAction.editTags': 'Edit Tags',
  'cli.editAction.editCategories': 'Edit Categories',
  ...
  'cli.edit.tagsSet': 'Tags on {name}: {tags}',
  'cli.edit.tagsCleared': 'Tags cleared on {name}.',
  'cli.edit.tagsInvalid': '{reason} Try again.',
  'cli.edit.categoriesSet': 'Categories on {name}: {categories}',
  'cli.edit.categoriesCleared': 'Categories cleared on {name}.',
  'cli.edit.categoriesInvalid': '{reason} Try again.',
  'cli.edit.categoriesVocabulary': 'Categories in this list: {categories}',
  'cli.edit.categoriesNone': 'This list has no categories yet.',
  'cli.edit.categoryOrderEmpty': 'Give at least one category, separated by commas.',
  'cli.edit.categoriesRenamed': 'Renamed category "{from}" to "{to}".',
  'cli.edit.categoriesReordered': 'Category order: {order}',
  ...
  'cli.deck.menuEditTags': 'Edit Deck Tags ({tags})',
